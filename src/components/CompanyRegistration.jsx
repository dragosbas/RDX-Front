...
function CompanyRegistration() {
    ...
    const [formFields,setFormFields]=useState(currentUser.companyEntity)
  ...
  return (
    <div className="chatview">
            ...
            <form className='form'>
                <button className='chatview__btn-send' disabled={false} onClick={(e) => { console.log(currentUser) }} >Inregistrare</button>
